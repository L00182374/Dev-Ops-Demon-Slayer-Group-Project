...
from projectToTest.projectToTest import lessThan  # import the function to be tested
from projectToTest.projectToTest import greaterThan  # import the second function to be tested
from projectToTest.projectToTest import equalTo  # import the third function to be tested
from projectToTest.projectToTest import notEqualTo  # import the fourth function to be tested
...
class TestProjectToTest(unittest.TestCase):  # create a test case class
    ...
    def test_lessThan(self):  # define a test method
        ...
        self.assertFalse(
            lessThan(2, 1)
        )  # Should return False because 2 is not less than 1
        self.assertFalse(
            lessThan(1, 1)
        )  # Should return False because 1 is not less than 1
        # self.assertFalse(lessThan('a',5)) # creates an error because 'a' and 5 are of different types
        logger.info(
            "Completed tests for lessThan function"
    ...
    def test_greaterThan(self):  # define another test method
        ...
        self.assertFalse(
            greaterThan(1, 2)
        )  # Should return False because 1 is not greater than 2
        self.assertFalse(
            greaterThan(1, 1)
        )  # Should return False because 1 is not greater than 1
        # self.assertFalse(greaterThan('a',5)) # creates an error because 'a' and 5 are of different types
        logger.info(
            "Completed tests for greaterThan function"
        )  # Log completion of this test
    ...
    def test_equalTo(self):  # define another test method
        ...
        logger.info(
            "Completed tests for equalTo function"
        )  # Log completion of this test
    ...
    def test_notEqualTo(self):  # define another test method
        ...
        logger.info(
            "Completed tests for notEqualTo function"
        )  # Log completion of this test
